...
public class EditCustomer extends javax.swing.JFrame {
    ...
    Customer c;
    public EditCustomer(Manager manager, Customer c) {
        initComponents();
         ...
         id.setText(c.getCid());
          name.setText(c.getCname());
           password.setText(c.getCpassword());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int index = manager.getCustomers().indexOf(c);
        
        manager.getCustomers().get(index).setCname(name.getText());
         manager.getCustomers().get(index).setCpassword(password.getText());
