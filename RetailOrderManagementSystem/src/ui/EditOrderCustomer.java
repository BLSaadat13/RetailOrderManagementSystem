 ...
 * @author AA
 */
public class EditOrderCustomer extends javax.swing.JFrame {
    ...
    Order o;
    public EditOrderCustomer(Manager manager, Order o) {
        initComponents();
         ...
         int index = manager.getOrders().indexOf(o);
         
         customerList.setSelectedItem(o.getCid());
         id.setText(o.getOid()); 
      updateTables();
    }
    ...
    private void initComponents() {
        ...
        customerList.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None" }));
    ...
    String cid;
        ...
        manager.getOrders().get(index).setOrderItems(orderItems);
