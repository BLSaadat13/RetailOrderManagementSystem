...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Scanner fileScanner = new Scanner(new File("customers.txt"));
            
             String username, password, cid;
            ...
            if(!isFound){
                JOptionPane.showMessageDialog(null, "User not found OR invalid credentials");
            }
